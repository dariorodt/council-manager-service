    ...
    <div class="d-flex">
        ...
        <nav class="bg-dark d-none d-lg-block" style="width: 250px; min-height: 100vh;">
            ...
            <ul class="nav flex-column">
                ...
                <li class="nav-item">
                    <a class="nav-link text-white d-flex justify-content-between align-items-center" data-bs-toggle="collapse" href="#ejecutivaMenu" role="button" aria-expanded="{{ request()->routeIs('committees.*') || request()->routeIs('projects.*') || request()->routeIs('programs.*') ? 'true' : 'false' }}">
                        <span><i class="bi bi-briefcase me-2"></i>Ejecutiva</span>
                        <i class="bi bi-chevron-down"></i>
                    </a>
                    <div class="collapse {{ request()->routeIs('committees.*') || request()->routeIs('projects.*') || request()->routeIs('programs.*') ? 'show' : '' }}" id="ejecutivaMenu">
                        <ul class="nav flex-column ms-3">
                            ...
                            <li class="nav-item">
                                <a class="nav-link text-white {{ request()->routeIs('programs.*') ? 'bg-primary' : '' }}" href="{{ route('programs.index') }}">
        ...
        <div class="offcanvas offcanvas-start bg-dark d-lg-none" tabindex="-1" id="sidebar">
            ...
            <div class="offcanvas-body p-0">
                <ul class="nav flex-column">
                    ...
                    <li class="nav-item">
                        <a class="nav-link text-white ps-4 {{ request()->routeIs('programs.*') ? 'bg-primary' : '' }}" href="{{ route('programs.index') }}">
                            <i class="bi bi-list-task me-2"></i>Programas
                        </a>
                    </li>
                    <li class="nav-item">
